...
Feature:Wiki Title and Search Verification
  ...
  Scenario: Seach functionality title verification
    When User searches "Steve Jobs" in the wiki page
    Then User should see "Steve Jobs" in the wiki title


  Scenario: Search functionality header verification
    When User searches "Steve Jobs" in the wiki page
    Then User should see "asdddddas" in the main header

  @wikiScenarioOutline
  Scenario Outline: Search functionality header verification
    When User searches "<searchValue>" in the wiki page
